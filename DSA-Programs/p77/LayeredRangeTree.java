...
class Point {
    int x, y; // For 2D, extend as needed
...
public class LayeredRangeTree {
    private Node root;

    public LayeredRangeTree(List<Point> points) {
    ...
    public static void main(String[] args) {
        ...
        LayeredRangeTree tree = new LayeredRangeTree(points);
